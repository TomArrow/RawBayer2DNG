...
{
    public class JpegBufferOutputWriterGreaterThan8BitCRI : JpegBlockOutputWriter
    {
        private int _width;
        private int _height;
        ...
        public JpegBufferOutputWriterGreaterThan8BitCRI(int width, int height, int precision, int componentCount, Memory<byte> output, int outputBitDepth)
        {
